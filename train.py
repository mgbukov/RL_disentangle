...
from src.networks import TransformerPE_2qRDM, PermutationInvariantMLP, MLP, TransformerPI_2qRDM_V
...
def train_ppo(config):
    ...
    # value_network = TransformerPI_2qRDM_V(
    #     in_shape[1], embed_dim=64, dim_mlp=256, n_heads=4, n_layers=2
    # ).to(device)
