"""
python3 ppo_train_agent.py -q 5 --env_batch 1024 --steps 40 -i 10001 --ereg 0.01
"""
...
log_dir = os.path.join("..", "logs", f"{args.num_qubits}qubits",
    f"ppo_traj_{args.env_batch}_iters_{args.num_iter}_entreg_{args.entropy_reg}{pretrain}")
