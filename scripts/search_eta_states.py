...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", "--agent", choices=["random", "beamsearch"], type=str, help="Agent", default="random")
    parser.add_argument("--num_iters", "-n", type=int, default=10_000)
    ...
    for eta in etas:
        ...
        for _ in range(args.samples):
            ...
            # if args.agent == "random":
            traj = agent.start(state, qstatesim, num_iters=args.num_iters, verbose=False)
            if traj is None:
